...
export IMAGE_URL=${IMAGE_URL-quay.io/sjmrhtap/java-quarkus-irolcqyk:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/sjm-rhtap/java-quarkus-irolcqyk-gitops
